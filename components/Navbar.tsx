...
function Navbar() {
  ...
  const renderThemeChanger = () => {
    if (!mounted) return (<div className='w-[50px] h-[50px]' />);
    ...
    if (currentTheme === "dark") {
      ...
      return (
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-moon text-dark"
          >
